package com.flickr.demo.common.ui
...
@Composable
fun rememberDatetime(string: String): String {
    return remember(string) {
        val localDateTime = Instant.parse(string).toJavaInstant()
        SimpleDateFormat.getDateTimeInstance().format(Date.from(localDateTime))
    }
}
